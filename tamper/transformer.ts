import type { Analyzer } from '$/tamper/mod.ts'
import { CodegenBlockStatement } from '$/tamper/codegen/codegen.blockstmt.ts'
import { CodegenVariable } from '$/tamper/codegen/codegen.variable.ts'
import { NameGen } from '$/tamper/name-gen.ts'
...
import { transform } from 'npm:@swc/core@1.11.8'
...
export class Transformer {
  ...
  async postTransform() {
    ...
    for (const funcName of Object.keys(this.postTransformedFunctions)) {
      ...
      const memExpProp = blockStmtWrapped.createComputedPropertyToRefString(
        funcName,
      )
